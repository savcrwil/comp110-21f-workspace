...
def end() -> None:
    ...
    if choice == "end":
        print(f"Thanks for playing, {player}. You finished the game with {points} points.")
    else:
        if choice == "mountains":
...
def forest() -> None:
    ...
    print(f"Bobby {bobby}: Hello, {player}! In order for you to pass through to the treasure, I need you to help me. I'm going to give you a random number between 1 and 5.")
